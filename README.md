...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/azure-mgmt-datafactory-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12185&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-mgmt-datafactory-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-mgmt-datafactory` can be installed with:

```
conda install azure-mgmt-datafactory
```

It is possible to list all of the versions of `azure-mgmt-datafactory` available on your platform with:
